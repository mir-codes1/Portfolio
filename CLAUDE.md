...
| `src/components/AssemblyGroup.tsx` | 2×1×1 grid container; handles idle Y-rotation + X-oscillation |
...
| `src/components/ExpandedCard.tsx` | Fixed-position dark-glass card (80% from left, 50% from top) |
